import type {Article, ArticleQuery} from '@/project1-libcommon/index'
...
export const patchArticle = (data: Article) => http.patch(`/blog/article/:${data.id}`, data).then(res => res.data)
